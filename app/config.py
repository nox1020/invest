...
SETTING_ANNUAL_WITHDRAWAL_PCT = "annual_withdrawal_pct"
...
PRICE_REFRESH_MIN = 5
PRICE_REFRESH_MAX = 3600

ANNUAL_WITHDRAWAL_OPTIONS = (5, 8, 10, 12, 15, 20, 25, 30)
ANNUAL_WITHDRAWAL_DEFAULT = 10
ANNUAL_WITHDRAWAL_MIN = 1
ANNUAL_WITHDRAWAL_MAX = 50
